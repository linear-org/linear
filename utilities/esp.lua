...
function ESP:Add(Data)
	...
	Container.Size = Settings.FrameSize
	...
	Divider.Size = UDim2.new(0.699999988, 0, 0.00600000005, 0)
...
function ESP:Tag(Data)
	...
	for fart, Active in ipairs(Actives) do
		if Active.Instance == Target or Active.Flag == Target then
			...
			TagLabel.Size = UDim2.new(9, 0, 0.108999997, 0)
			...
			TagLabel.Parent = Active.Container
...
function ESP:Settings(Data)
	...
	for fart, Active in ipairs(Actives) do
		if Active.Container then Active.Container.Size = Settings.FrameSize end
